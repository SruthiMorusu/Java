...
public class MemberDiscount {
	...
	public MemberDiscount(String code, String description, Date startDate, int daysPeriod, int percentage){
		this.code = code;
    ...
    public String toString() {
		...
		+ period + "," + getPercentage()  + "," + DiscountManager.APPLICABLE_TO_MEMBER_FLAG);
    }
}
