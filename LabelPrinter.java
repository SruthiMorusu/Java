...
public class LabelPrinter extends Dialog implements IPrinter
{
	private static final long serialVersionUID = -8804441140743623440L;
	Frame currentParent;
	JTextArea textArea;
	
	public LabelPrinter(Frame parent) {
		super(parent, "Label Printer");
		this.setSize(443, 150);
